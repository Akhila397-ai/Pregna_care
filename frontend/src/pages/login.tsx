      ...
      <div className="flex flex-col px-8 py-6 lg:px-16 lg:py-10 w-full lg:w-1/2 xl:w-5/12 h-full overflow-y-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-[#5a7a5a] text-base leading-relaxed max-w-xs">
            Sign in to continue your pregnancy journey with personalized care and support.
          </p>
        </div>
        ...
        <div className="space-y-5 flex-1">
          ...
          {/* Email */}
          <div>
            <label className="block text-sm font-semibold text-[#2d4a2d] mb-1.5">Email or Phone</label>
...
/>
          ...
          <p className="text-center text-sm text-[#5a7a5a]">
            ...
            <a href="/signup" className="text-[#2ecc71] font-semibold hover:underline">
              Sign up
            </a>
          </p>
        </div>
