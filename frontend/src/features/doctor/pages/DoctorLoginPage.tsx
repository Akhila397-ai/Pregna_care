  ...
  return (
    <div className="h-screen overflow-hidden flex flex-col lg:flex-row font-sans bg-[var(--bg-primary)]">
      ...
      <div className="flex flex-col px-8 py-6 lg:px-16 lg:py-10 w-full lg:w-1/2 xl:w-5/12 h-full overflow-y-auto bg-[var(--bg-surface)] transition-colors duration-200">
        ...
        {/* Badge */}
        <div className="inline-flex items-center gap-2 bg-emerald-50 dark:bg-emerald-950/40 border border-emerald-500/20 text-emerald-600 dark:text-emerald-400 text-xs font-semibold px-3 py-1.5 rounded-full mb-6 w-fit">
          🩺 Doctor Portal
        </div>
        ...
        <div className="space-y-5 flex-1">
          ...
          {/* API Error */}
          {error && (
            <div className="flex items-center gap-2 text-sm text-rose-500 bg-rose-500/10 border border-rose-500/20 rounded-xl px-4 py-2.5">
          ...
          <div>
            ...
            <div className="relative">
              ...
              />
              <svg className="absolute right-3 top-1/2 -translate-y-1/2 w-4 h-4 text-[var(--text-muted)]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round"
          ...
          <div className="bg-[var(--bg-muted)] border border-[var(--border-primary)] rounded-xl p-4 space-y-2">
          ...
          <button
            ...
            className="w-full py-3.5 rounded-xl bg-emerald-600 hover:bg-emerald-700
              active:scale-[0.98] text-white font-bold text-base shadow-lg
              shadow-emerald-500/20 transition-all duration-200 disabled:opacity-50
