      ...
      <div className="flex flex-col px-8 py-6 lg:px-16 lg:py-10 w-full lg:w-1/2 xl:w-5/12 h-full overflow-y-auto bg-[var(--bg-surface)] transition-colors duration-200">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-2.5">
            <div className="w-10 h-10 rounded-2xl bg-emerald-50 dark:bg-emerald-950/40 text-emerald-600 dark:text-emerald-400 flex items-center justify-center shadow-sm">
        ...
        {/* Badge */}
        <div className="inline-flex items-center gap-2 bg-emerald-50 dark:bg-emerald-950/40 text-emerald-600 dark:text-emerald-400 text-xs font-semibold px-3 py-1.5 rounded-full mb-6 w-fit border border-emerald-100 dark:border-emerald-900/60">
        ...
        {/* Heading */}
        <div className="mb-8">
          <h1 className="text-3xl lg:text-4xl font-extrabold text-[var(--text-primary)] leading-tight mb-2 tracking-tight">
            Welcome Back, Admin
          </h1>
          <p className="text-[var(--text-secondary)] text-sm leading-relaxed max-w-sm">
            Sign in to manage users, doctors, and platform health.
          </p>
        </div>
        ...
        <div className="space-y-5 flex-1">
          {/* API error */}
          {error && (
            <div className="flex items-center gap-2 text-sm text-rose-600 dark:text-rose-400 bg-rose-50 dark:bg-rose-950/40 border border-rose-100 dark:border-rose-900/60 rounded-xl px-4 py-2.5">
              <svg
          ...
          <div>
            ...
            {errors.email && <p className="text-rose-500 text-xs mb-1">{errors.email}</p>}
          ...
          <div>
            ...
            {errors.password && <p className="text-rose-500 text-xs mb-1">{errors.password}</p>}
            <div className="relative">
              <input
      ...
      <div className="relative hidden lg:flex h-full w-full lg:w-1/2 xl:w-7/12 overflow-hidden rounded-tl-3xl rounded-bl-3xl border-l border-[var(--border-primary)]">
        ...
        <div className="absolute top-12 left-10 right-10">
          ...
          <div className="space-y-3">
            {[
              { icon: '👥', label: 'User Management', desc: 'View, block and manage patient accounts' },
              { icon: '🩺', label: 'Doctor Management', desc: 'Verify and authorize doctor applications' },
              { icon: '📊', label: 'Platform Analytics', desc: 'Monitor system activity and performance' },
            ].map((item) => (
              <div
                key={item.label}
                className="flex items-center gap-3 bg-black/40 backdrop-blur-md rounded-xl px-4 py-3 border border-white/10"
              >
        ...
        <div className="absolute bottom-12 left-10 right-10 text-white">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-white/70 text-xs">Platform Administrator</p>
            </div>
          </div>
        </div>
      </div>
